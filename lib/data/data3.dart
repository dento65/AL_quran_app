class Brain3 {
  ...
  dynamic getSurahVerses(int index)
  {
    return(_map2[index]['count']);
  }
  dynamic getSurahNameA(int index)
  {
    return(_map2[index]['titleAr']);
  }
  dynamic getSurahNameE(int index)
  {
    return(_map2[index]['title']);
  }
